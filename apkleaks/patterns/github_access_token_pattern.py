...
KEYWORD_REGEXES = ["[<]?.*[g|G][i|I][t|T].*[=|>].*", "[<]?.*[t|T][o|O][k|K][e|E][n|N].*[=|>].*", 
                    "[<]?.*[g|G][i|I][t|T][h|H][u|U][b|B][_|-| ]?[a|A][c|C][c|C][e|E][s|S][s|S][_|-| ]?[t|T][o|O][k|K][e|E][n|N].*[=|>].*"]

KEYWORD_SCORE = 10
BETTER_KEYWORD_SCORE = 20

class GithubAccessTokenPattern(Pattern):
    def __init__(self):
        self.name = NAME
